...
export const appRouter = router({
  ...
  auth: router({
    ...
    logout: publicProcedure.mutation(({ ctx }) => {
      ...
      ctx.res.clearCookie(COOKIE_NAME, { ...cookieOptions, maxAge: -1   // ============ Oral History Module ============
  oralHistory: router({
  ...
  immersive: router({
    ...
    updateProfile: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        // Update session token if name changed (optional, but good for UI consistency if stored in token)
        // But our sdk.createSessionToken uses name in payload.
        // So we might want to refresh the cookie.
    ...
    create: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        await db.createOrder({
          ...
          unitPrice: input.unitPrice.toString(), // DB expects decimal (string or number depending on driver, but drizzle decimal maps to string usually)
  ...
  community: router({
    ...
    create: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        // Note: Drizzle should handle JSON serialization for json fields
  ...
  experience: router({
    start: publicProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        // Check if there is an in-progress record? Maybe allow multiple.
        // For simplicity, just create new.
